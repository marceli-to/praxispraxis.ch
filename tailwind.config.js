...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        'regular': ['IBM Plex Mono', ...defaultTheme.fontFamily.sans],
        'italic': ['IBM Plex Mono', ...defaultTheme.fontFamily.sans],
        'semibold': ['IBM Plex Mono', ...defaultTheme.fontFamily.sans],
      },
